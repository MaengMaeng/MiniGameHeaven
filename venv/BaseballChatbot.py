    ...
    if event_type == "app_mention":
        ...
        if user_id not in Game:
            ...
            if game_name == '<@UEXDMJ0HY>' or game_name == "게임목록":
                ...
                print((game_name in game_list), "씨발왜안돼")
            ...
            if game_name == '베이스볼':
                ...
                keywords = up_and_down(text, user_id) # 업앤다운 함수로 바꿈
            elif game_name == '가위바위보':
                keywords = game_rock_paper_scissors(text, user_id) # 가위바위보 함수로 바꿈
...
def hears():
    ...
    try:
        if slack_event['event_time'] < (datetime.datetime.now() - datetime.timedelta(seconds=5)).timestamp():
            print("LATE MESSAGE")
